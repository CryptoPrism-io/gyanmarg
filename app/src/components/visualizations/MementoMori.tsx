          ...
          {!showVisualization ? (
            <div className="w-full max-w-xs space-y-4">
              ...
              <motion.button
                ...
                className="w-full py-3 bg-amber-500/20 border border-amber-500/50 rounded-lg text-sm text-amber-400 backdrop-blur-sm"
            ...
            >
              ...
              {/* Reflection */}
              <div className="relative overflow-hidden rounded-lg">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500/[0.12] to-amber-500/[0.05] backdrop-blur-sm" />
                <div className="absolute inset-0 border border-amber-500/30 rounded-lg" />
                <div className="relative z-10 p-3">
