      ...
      <div className="relative z-10 p-5">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="relative w-full max-w-xs h-40">
            {commandType === 'centralized' ? (
              ...
              <div className="relative w-full h-full">
                {/* Leader in center */}
                <motion.div
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-red-500/20 backdrop-blur-sm border-2 border-red-500/50 flex items-center justify-center"
                >
                ...
                {teamMembers.map((member, idx) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="absolute w-10 h-10 rounded-full bg-green-500/20 backdrop-blur-sm border-2 border-green-500/50 flex items-center justify-center cursor-pointer hover:bg-green-500/30"
                      style={{ left: `${x}%`, top: `${y}%`, transform: 'translate(-50%, -50%)' }}
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-500/20 backdrop-blur-sm border border-blue-500/50 rounded-lg text-xs text-blue-400 hover:bg-blue-500/30"
          >
