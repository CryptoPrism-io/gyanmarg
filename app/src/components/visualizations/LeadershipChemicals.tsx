...
export function LeadershipChemicals() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-[var(--viz-bg)]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/[0.03] via-transparent to-rose-500/[0.02]" />
      ...
      <div className="relative z-10 p-5">
        <div className="flex flex-col items-center gap-4">
                  ...
                  <>
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <span className={`text-[8px] px-2 py-0.5 rounded-full backdrop-blur-sm ${
                          chem.type === 'selfish'
          ...
          {/* Leadership insight */}
          <div className="w-full max-w-xs bg-green-500/10 backdrop-blur-sm border border-green-500/30 rounded-lg p-3">
