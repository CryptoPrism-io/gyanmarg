      ...
      <div className="relative z-10 p-5">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="w-full max-w-xs h-24 bg-[var(--viz-tile)] backdrop-blur-sm border border-[var(--viz-border)] rounded-lg p-3 relative overflow-hidden">
            ...
            <div className={`absolute top-2 right-2 px-2 py-0.5 rounded-full text-[10px] backdrop-blur-sm ${
              phase === 'work'
          ...
          <div className="flex gap-2">
            {phase === 'idle' ? (
              <motion.button
                onClick={startCycle}
                className="px-6 py-2 bg-blue-500/20 backdrop-blur-sm border border-blue-500/50 rounded-lg text-sm text-blue-400"
          ...
          {/* Cycles completed */}
          {cycles > 0 && (
            <div className="bg-amber-500/10 backdrop-blur-sm border border-amber-500/30 rounded-lg px-4 py-2">
