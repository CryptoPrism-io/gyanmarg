      ...
      <div className="relative z-10 p-5">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="relative w-full max-w-xs overflow-hidden rounded-lg">
            <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 via-yellow-500/5 to-transparent backdrop-blur-sm" />
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="text-center">
                <div className="relative w-16 h-16 overflow-hidden rounded-lg">
                  <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 via-green-500/10 to-transparent backdrop-blur-sm" />
              ...
              <motion.div
                className="flex-1 h-1 mx-2 bg-gradient-to-r from-green-500/50 to-amber-500/50 rounded-full"
              ...
              <div className="text-center">
                <div className="relative w-16 h-16 overflow-hidden rounded-lg">
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-500/20 via-amber-500/10 to-transparent backdrop-blur-sm" />
                  <div className="absolute inset-0 border border-amber-500/50 rounded-lg" />
                  <div className="relative z-10 h-full flex flex-col items-center justify-center">
