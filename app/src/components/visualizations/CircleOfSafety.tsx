      ...
      <div className="relative z-10 p-5">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="relative w-48 h-48">
            ...
            {/* Circle of safety */}
            <motion.div
              className="absolute rounded-full bg-green-500/10 backdrop-blur-sm border-4 border-green-500/50"
              style={{
                top: '50%',
                left: '50%',
          ...
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className={`w-full max-w-xs p-3 rounded-lg border backdrop-blur-sm text-center ${
