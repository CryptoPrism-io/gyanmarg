      ...
      <div className="relative z-10 p-5">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="w-full max-w-xs">
            ...
            <div className="h-4 bg-[var(--viz-tile)] backdrop-blur-sm rounded-full overflow-hidden relative border border-[var(--viz-border)]">
              <motion.div
                className={`h-full ${
                  balance >= 80
              ...
              />
              <span className="absolute inset-0 flex items-center justify-center text-[10px] text-[var(--viz-text)] font-bold">
                {balance}%
              </span>
            </div>
          </div>
          ...
          <div className="w-full max-w-xs space-y-2">
            ...
            {actions.map((action, idx) => (
              ...
              >
                ...
                <div className="absolute inset-0 border border-[var(--viz-border)] rounded-lg hover:border-green-500/30 transition-all" />
