...
export const memoryLearningFlashcards: SpacedRepetitionCard[] = [
  ...
  {
    id: 'fc-mem-002',
    front: 'Shallow vs. Deep Encoding: What\'s the key difference?',
    back: 'Shallow: Process surface features. Deep: Process meaning & connections for stronger memories. Levels of Processing Theory explains this; encode deeply!',
    category: 'Master Synthesis',
    source: 'Learning Science',
    pathwayId: 'master-synthesis',
  ...
  {
    id: 'fc-mem-012',
    front: 'Recall vs. Recognition: What\'s the difference?',
    back: 'Recall: Generate info; effortful, strong learning. Recognition: Identify info; easier, less diagnostic. ID: fc-mem-012',
    category: 'Master Synthesis',
    source: 'Learning Science',
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
  ...
  {
    id: 'fc-mem-030',
    front: 'Combine elaborative interrogation with what other strategies?',
    back: 'Test explanations with retrieval; space elaborations; interleave topics; teach others; visualize causations. ID: fc-mem-030',
    category: 'Master Synthesis',
    source: 'Learning Science',
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
  ...
  {
    id: 'fc-mem-034',
    front: 'Memory Palace: What limits its effectiveness?',
    back: 'Time-intensive setup; Suits ordered lists better than concepts. Practice often; Limited locations; Overuse causes confusion. ID: fc-mem-034',
    category: 'Master Synthesis',
    source: 'Learning Science',
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
  ...
  {
    id: 'fc-mem-044',
    front: 'Implement interleaving: How should you do it in a study session?',
    back: 'Mix topics; Encode each enough (no random switch); Include new & old; Interleave similar concepts; Resist blocking when hard. ID: fc-mem-044',
    category: 'Master Synthesis',
    source: 'Learning Science',
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
  ...
  {
    id: 'fc-mem-049',
    front: 'Promote far transfer: What conditions must be met?',
    back: 'Vary practice & contexts; teach principles; compare examples; apply in novel situations; interleave; reflect & understand why/how. ID: fc-mem-049',
    category: 'Master Synthesis',
    source: 'Learning Science',
    pathwayId: 'master-synthesis',
    difficulty: 'advanced',
