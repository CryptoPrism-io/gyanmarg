...
export const careerFlashcards: SpacedRepetitionCard[] = [
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'beginner',
    tags: ['career', 'professional-development', 'personal-branding']
  },
  {
    id: 'fc-car-006',
  ...
  {
    id: 'fc-car-007',
    front: 'Build authority online? (fc-car-007)',
    back: 'Repurpose core content: blog to LinkedIn/Twitter/podcast/newsletter. Consistent output builds momentum. (Life Design; career, professional-development, personal-branding; intermediate)',
    category: 'Life Design',
    source: 'Career Development',
    pathwayId: 'life-design',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'intermediate',
    tags: ['career', 'professional-development', 'salary-negotiation']
  },
  {
    id: 'fc-car-010',
  ...
  {
    id: 'fc-car-012',
    front: 'What is BATNA and why is it key in negotiation?',
    back: 'BATNA = Best Alternative To Negotiated Agreement. Know your BATNA; it determines your walk-away point and negotiating power. ID: fc-car-012',
    category: 'Life Design',
    source: 'Career Development',
    pathwayId: 'life-design',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'beginner',
    tags: ['career', 'professional-development', 'interview-skills']
  },
  {
    id: 'fc-car-014',
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'intermediate',
    tags: ['career', 'professional-development', 'skill-stacking']
  },
  {
    id: 'fc-car-018',
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'intermediate',
    tags: ['career', 'professional-development', 'career-pivots']
  },
  {
    id: 'fc-car-022',
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'advanced',
    tags: ['career', 'professional-development', 'building-leverage']
  },
  {
    id: 'fc-car-026',
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'intermediate',
    tags: ['career', 'professional-development', 'remote-work']
  },
  {
    id: 'fc-car-030',
    front: 'Remote work: Fight isolation, build genuine relationships?',
    back: 'Schedule 1:1s; join virtual socials; chat casually. Attend events, find buddies; use async video. Be proactive: reach out!',
    category: 'Life Design',
    source: 'Career Development',
    pathwayId: 'life-design',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    pathwayId: 'life-design',
    difficulty: 'intermediate',
    tags: ['career', 'professional-development', 'mentorship']
  },
  {
    id: 'fc-car-034',
  ...
  {
    id: 'fc-car-037',
    front: 'Build a strong professional reputation. How?',
    back: 'Deliver quality; exceed expectations; be reliable. Share credit; own failures; help others. Build expertise; maintain integrity. Small actions compound!',
    category: 'Life Design',
    source: 'Career Development',
    pathwayId: 'life-design',
    difficulty: 'beginner',
    tags: ['career', 'professional-development', 'professional-reputation']
  },
  {
    id: 'fc-car-038',
    front: 'How do you recover professionally from a reputation-damaging mistake?',
    back: 'Own the mistake fully; apologize sincerely; learn and grow; rebuild trust through consistent actions; seek feedback. ID: fc-car-038',
    category: 'Life Design',
    source: 'Career Development',
    pathwayId: 'life-design',
    difficulty: 'intermediate',
