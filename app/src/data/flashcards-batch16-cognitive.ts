...
export const cognitiveScienceFlashcards: SpacedRepetitionCard[] = [
  ...
  {
    id: 'fc-cognitive-001',
    front: 'Neuroplasticity: What is it, and how does it impact personal growth?',
  ...
  {
    id: 'fc-cognitive-002',
    front: 'Neurons that fire together do what?',
  ...
  {
    id: 'fc-cognitive-003',
    front: 'What is the critical period hypothesis & can adults learn effectively?',
  ...
  {
    id: 'fc-cognitive-004',
    front: 'How does brain plasticity impact cortical maps during skill acquisition?',
  ...
  {
    id: 'fc-cognitive-005',
    front: 'BDNF: Role in brain plasticity & how to increase it?',
  ...
  {
    id: 'fc-cognitive-006',
    front: 'Working memory: Define it & its capacity limit?',
  ...
  {
    id: 'fc-cognitive-007',
    front: 'Working vs. Short-Term Memory: What\'s the key difference?',
  ...
  {
    id: 'fc-cognitive-008',
    front: 'What is chunking & how does it boost memory capacity?',
  ...
  {
    id: 'fc-cognitive-009',
    front: 'Can you train and improve working memory capacity?',
  ...
  {
    id: 'fc-cognitive-010',
    front: 'How does anxiety impact working memory?',
  ...
  {
    id: 'fc-cognitive-011',
    front: 'Cognitive Load Theory: How does it impact learning?',
  ...
  {
    id: 'fc-cognitive-012',
    front: 'Split-attention effect: What is it, and how do you avoid it?',
  ...
  {
    id: 'fc-cognitive-013',
    front: 'Define the redundancy effect in learning',
  ...
  {
    id: 'fc-cognitive-014',
    front: 'How does expertise affect the best way to learn?',
  ...
  {
    id: 'fc-cognitive-015',
    front: 'Worked example effect: What is it, and when is it most effective?',
  ...
  {
    id: 'fc-cognitive-016',
    front: 'What are the two primary attention systems in the brain?',
  ...
  {
    id: 'fc-cognitive-017',
    front: 'Define inattentional blindness & its implications for attention',
  ...
  {
    id: 'fc-cognitive-018',
    front: 'Why is \'multitasking\' a myth? What really occurs?',
  ...
  {
    id: 'fc-cognitive-019',
    front: 'What is attention residue & how does it impact productivity?',
  ...
  {
    id: 'fc-cognitive-020',
    front: 'How long can humans focus & what impacts attention duration?',
  ...
  {
    id: 'fc-cognitive-021',
    front: 'How do experts recognize patterns unlike novices?',
  ...
  {
    id: 'fc-cognitive-022',
    front: 'Explain recognition-primed decision (RPD) model. How do experts use it?',
  ...
  {
    id: 'fc-cognitive-023',
    front: 'Define apophenia, and why does it lead to false pattern detection?',
  ...
  {
    id: 'fc-cognitive-024',
    front: 'Analogical reasoning: How does it work, and why is it useful?',
  ...
  {
    id: 'fc-cognitive-025',
    front: 'Define the mere exposure effect & its relation to pattern recognition',
  ...
  {
    id: 'fc-cognitive-027',
    front: 'How does mind-wandering boost creativity & problem-solving?',
  ...
  {
    id: 'fc-cognitive-028',
    front: 'DMN & Rumination/Depression: What\'s the link?',
  ...
  {
    id: 'fc-cognitive-029',
    front: 'Meditation\'s impact on Default Mode Network?',
  ...
  {
    id: 'fc-cognitive-030',
    front: 'Why does boredom matter for the brain & creativity?',
  ...
  {
    id: 'fc-cognitive-031',
    front: 'How does sleep consolidate memories & learning in the brain?',
  ...
  {
    id: 'fc-cognitive-032',
    front: 'How does sleep deprivation affect learning?',
  ...
  {
    id: 'fc-cognitive-033',
    front: 'Optimal study-sleep learning strategy?',
  ...
  {
    id: 'fc-cognitive-034',
    front: 'How does REM sleep boost creativity & insight?',
  ...
  {
    id: 'fc-cognitive-035',
    front: 'Glymphatic system: What is it, and why is it crucial for brain health?',
  ...
  {
    id: 'fc-cognitive-036',
    front: 'Define flow state & key neurological changes in brain during flow',
  ...
  {
    id: 'fc-cognitive-037',
    front: 'What conditions trigger a flow state?',
  ...
  {
    id: 'fc-cognitive-038',
    front: 'Flow state: Why boost productivity & by how much?',
  ...
  {
    id: 'fc-cognitive-039',
    front: 'Explain transient hypofrontality\'s role in peak performance',
  ...
  {
    id: 'fc-cognitive-040',
    front: 'Flow interrupted? How do you quickly regain flow state?',
  ...
  {
    id: 'fc-cognitive-041',
    front: 'Dopamine\'s role in motivation: What\'s its *actual* function?',
  ...
  {
    id: 'fc-cognitive-042',
    front: 'Dopamine tolerance: How does it impact motivation?',
  ...
  {
    id: 'fc-cognitive-043',
    front: 'Why are variable rewards so addictive, according to dopamine?',
  ...
  {
    id: 'fc-cognitive-044',
    front: 'Boost motivation: How use dopamine strategically?',
  ...
  {
    id: 'fc-cognitive-045',
    front: 'Dopamine & Effort: What\'s the relationship?',
  ...
  {
    id: 'fc-cognitive-046',
    front: 'Most effective, universally available cognitive enhancer?',
  ...
  {
    id: 'fc-cognitive-047',
    front: 'How does learning new skills improve cognitive function?',
  ...
  {
    id: 'fc-cognitive-048',
    front: 'Define cognitive offloading and when to use it effectively',
  ...
  {
    id: 'fc-cognitive-049',
    front: 'How does social interaction boost cognitive function?',
  ...
  {
    id: 'fc-cognitive-050',
    front: 'Optimal daily structure for peak cognitive performance?',
