...
export const pythonDataScienceFlashcards: SpacedRepetitionCard[] = [
  ...
  {
    id: 'fc-pyds-001',
    front: 'Name Python\'s main mutable vs. immutable data types',
    back: 'Immutable: int; float; str; tuple. Mutable: list; dict; set. Mutability impacts side effects; dict keys; function args; memory',
