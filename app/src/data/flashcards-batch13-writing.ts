...
export const writingFlashcards: SpacedRepetitionCard[] = [
  // Clear Writing Principles
  {
    ...
    tags: ['writing', 'content', 'communication', 'clarity']
  },
  {
    id: 'fc-writ-002',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'clarity', 'style']
  },
  {
    id: 'fc-writ-003',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'structure', 'clarity']
  },
  {
    id: 'fc-writ-004',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'storytelling', 'structure']
  },
  {
    id: 'fc-writ-006',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'advanced',
    tags: ['writing', 'content', 'storytelling', 'narrative']
  },
  {
    id: 'fc-writ-007',
    front: 'What does "in medias res" mean?',
    back: 'Start a story mid-action; Engage readers immediately. Latin for "into the middle of things."',
    category: 'Master Synthesis',
    source: 'Writing & Content',
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'storytelling', 'technique']
  },
  {
    id: 'fc-writ-008',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'headlines', 'copywriting']
  },
  {
    id: 'fc-writ-010',
    front: 'What is the purpose of a curiosity gap in writing?',
    back: 'Create a need to know; Intrigue readers; withhold full payoff. Tease; don\'t reveal all',
    category: 'Master Synthesis',
    source: 'Writing & Content',
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'hooks', 'engagement']
  },
  {
    id: 'fc-writ-011',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'headlines', 'formulas']
  },
  {
    id: 'fc-writ-012',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'editing', 'revision']
  },
  {
    id: 'fc-writ-014',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'editing', 'discipline']
  },
  {
    id: 'fc-writ-015',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'editing', 'process']
  },
  {
    id: 'fc-writ-016',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'productivity', 'block']
  },
  {
    id: 'fc-writ-018',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'creativity', 'block']
  },
  {
    id: 'fc-writ-019',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'mindset', 'block']
  },
  {
    id: 'fc-writ-020',
  ...
  {
    id: 'fc-writ-021',
    front: 'Who should you target when writing content?',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'audience', 'strategy']
  },
  {
    id: 'fc-writ-022',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'audience', 'planning']
  },
  {
    id: 'fc-writ-023',
    front: 'Audience affects writing how?',
    back: 'Tailor content to audience needs and knowledge; Improve engagement; Increase resonance',
    category: 'Master Synthesis',
    source: 'Writing & Content',
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'audience', 'engagement']
  },
  {
    id: 'fc-writ-024',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'strategy', 'planning']
  },
  {
    id: 'fc-writ-026',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'strategy', 'efficiency']
  },
  {
    id: 'fc-writ-027',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'advanced',
    tags: ['writing', 'content', 'strategy', 'architecture']
  },
  {
    id: 'fc-writ-028',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'copywriting', 'framework']
  },
  {
    id: 'fc-writ-030',
    front: 'Features vs. Benefits in copywriting?',
    back: 'Features: Describe WHAT it *is*. Benefits: Describe WHAT it *does* for the user; focus on outcomes and positive impacts',
    category: 'Master Synthesis',
    source: 'Writing & Content',
    pathwayId: 'master-synthesis',
    difficulty: 'beginner',
    tags: ['writing', 'content', 'copywriting', 'persuasion']
  },
  {
    id: 'fc-writ-031',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'technical', 'structure']
  },
  {
    id: 'fc-writ-035',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'technical', 'instructions']
  },
  {
    id: 'fc-writ-036',
    front: 'How do you simplify technical writing for a broader audience?',
  ...
  },
  {
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'persuasion', 'rhetoric']
  },
  {
    id: 'fc-writ-038',
    front: 'How should you present opposing arguments for best effect?',
    back: 'Acknowledge & strengthen counter-arguments first, then refute; Avoid straw-manning; Build ethos & anticipate objections',
    category: 'Master Synthesis',
    source: 'Writing & Content',
    pathwayId: 'master-synthesis',
    difficulty: 'advanced',
    tags: ['writing', 'content', 'persuasion', 'argumentation']
  },
  {
    id: 'fc-writ-039',
    ...
    pathwayId: 'master-synthesis',
    difficulty: 'intermediate',
    tags: ['writing', 'content', 'persuasion', 'psychology']
  },
  {
    id: 'fc-writ-040',
