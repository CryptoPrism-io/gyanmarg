...
export const focusFlashcards: SpacedRepetitionCard[] = [
  ...
  {
    id: 'fc-foc-003',
    front: 'How to reduce attention residue when switching tasks?',
    back: 'Finish tasks; note progress and next steps; use transition ritual; batch similar tasks; schedule buffer time. ID: fc-foc-003',
    category: 'Personal Development',
    source: 'Deep Work & Focus',
    pathwayId: 'personal-development',
    difficulty: 'intermediate',
  ...
  {
    id: 'fc-foc-034',
    front: 'Pre-focus ritual: What key elements should you include?',
    back: 'Prepare physically, digitally, & mentally; use an environmental cue. Keep it brief & consistent for improved focus. ID: fc-foc-034',
    category: 'Personal Development',
    source: 'Deep Work & Focus',
    pathwayId: 'personal-development',
    difficulty: 'intermediate',
  ...
  {
    id: 'fc-foc-035',
    front: 'Shutdown ritual: what is it & why does it protect focus?',
    back: 'End work with a routine for psychological closure. Review; capture; plan; close; prevent work intrusion; ensure recovery. ID: fc-foc-035',
    category: 'Personal Development',
    source: 'Deep Work & Focus',
    pathwayId: 'personal-development',
    difficulty: 'intermediate',
  ...
  {
    id: 'fc-foc-038',
    front: 'How do restorative breaks differ from depleting ones?',
    back: 'Restore focus: nature; move; connect; meditate; disengage. Avoid: email; scrolling; decisions. Rest attention, don\'t just switch tasks. fc-foc-038',
    category: 'Personal Development',
    source: 'Deep Work & Focus',
    pathwayId: 'personal-development',
    difficulty: 'intermediate',
