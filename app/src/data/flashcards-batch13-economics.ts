...
export const economicsFlashcards: SpacedRepetitionCard[] = [
  // Supply and Demand
  {
    id: 'fc-econ-001',
    ...
    difficulty: 'beginner',
    tags: ['economics', 'supply-demand', 'fundamentals']
  },
  {
    id: 'fc-econ-002',
    front: 'What\'s the law of supply?',
    back: 'Increase price, increase quantity supplied (and vice-versa). Higher prices incentivize more production; forms an upward-sloping curve. fc-econ-002',
    category: 'Wealth Building',
    source: 'Economics',
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'supply-demand', 'markets']
  },
  {
    id: 'fc-econ-004',
    ...
    tags: ['economics', 'supply-demand', 'elasticity']
  },
  {
    id: 'fc-econ-005',
    front: 'Demand Curve: What causes a shift vs. a movement along the curve?',
    back: 'Shift: Change in factors other than price. Movement: Price change; affects quantity demanded. ID: fc-econ-005',
    category: 'Wealth Building',
    source: 'Economics',
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'opportunity-cost', 'productivity']
  },
  {
    id: 'fc-econ-008',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'opportunity-cost', 'behavioral-economics']
  },
  {
    id: 'fc-econ-009',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'opportunity-cost', 'production']
  },
  {
    id: 'fc-econ-010',
    front: 'Why are incentives core to economics?',
    back: 'Incentives drive behavior; economics studies this. Use incentives to predict actions; improve policies/decisions. ID: fc-econ-010',
    category: 'Wealth Building',
    source: 'Economics',
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'incentives', 'fundamentals']
  },
  {
    id: 'fc-econ-011',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'incentives', 'behavior']
  },
  {
    id: 'fc-econ-012',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'incentives', 'agency']
  },
  {
    id: 'fc-econ-013',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'incentives', 'risk']
  },
  {
    id: 'fc-econ-014',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'marginal-thinking', 'decision-making']
  },
  {
    id: 'fc-econ-015',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'marginal-thinking', 'utility']
  },
  {
    id: 'fc-econ-016',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'marginal-thinking', 'business']
  },
  {
    id: 'fc-econ-017',
    front: 'Marginal thinking: How use it in personal finance?',
    back: 'Assess incremental value of each choice; Optimize spending/investment for best return. ID: fc-econ-017',
    category: 'Wealth Building',
    source: 'Economics',
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'marginal-thinking', 'personal-finance']
  },
  {
    id: 'fc-econ-018',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'inflation', 'monetary-policy']
  },
  {
    id: 'fc-econ-019',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'beginner',
    tags: ['economics', 'GDP', 'development']
  },
  {
    id: 'fc-econ-027',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'monetary-policy', 'central-banking']
  },
  {
    id: 'fc-econ-028',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'monetary-policy', 'finance']
  },
  {
    id: 'fc-econ-031',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'game-theory', 'trade']
  },
  {
    id: 'fc-econ-035',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'behavioral-economics', 'negotiation']
  },
  {
    id: 'fc-econ-039',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'behavioral-economics', 'personal-finance']
  },
  {
    id: 'fc-econ-040',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'behavioral-economics', 'policy']
  },
  {
    id: 'fc-econ-041',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'market-failures', 'policy']
  },
  {
    id: 'fc-econ-042',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'market-failures', 'externalities']
  },
  {
    id: 'fc-econ-043',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'market-failures', 'public-goods']
  },
  {
    id: 'fc-econ-044',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'advanced',
    tags: ['economics', 'market-failures', 'information']
  },
  {
    id: 'fc-econ-045',
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'market-failures', 'resources']
  },
  {
    id: 'fc-econ-046',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'intermediate',
    tags: ['economics', 'comparative-advantage', 'career']
  },
  {
    id: 'fc-econ-049',
  ...
  },
  {
    ...
    pathwayId: 'wealth-building',
    difficulty: 'advanced',
    tags: ['economics', 'comparative-advantage', 'trade-policy']
  }
];
