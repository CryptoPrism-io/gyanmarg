...
export default {
  ...
  // Safelist for dynamically-generated category colors
  safelist: [
    // Text colors
    'text-purple-400', 'text-blue-400', 'text-emerald-400', 'text-green-400',
    'text-amber-400', 'text-indigo-400', 'text-cyan-400', 'text-rose-400',
    'text-slate-400', 'text-orange-400', 'text-teal-400', 'text-pink-400',
    'text-yellow-400', 'text-red-400', 'text-violet-400',
    // Background colors with opacity
    'bg-purple-500/20', 'bg-blue-500/20', 'bg-emerald-500/20', 'bg-green-500/20',
    'bg-amber-500/20', 'bg-indigo-500/20', 'bg-cyan-500/20', 'bg-rose-500/20',
    'bg-slate-500/20', 'bg-orange-500/20', 'bg-teal-500/20', 'bg-pink-500/20',
    'bg-yellow-500/20', 'bg-red-500/20', 'bg-violet-500/20',
    // Border colors with opacity
    'border-purple-500/50', 'border-blue-500/50', 'border-emerald-500/50', 'border-green-500/50',
    'border-amber-500/50', 'border-indigo-500/50', 'border-cyan-500/50', 'border-rose-500/50',
    'border-slate-500/50', 'border-orange-500/50', 'border-teal-500/50', 'border-pink-500/50',
    'border-yellow-500/50', 'border-red-500/50', 'border-violet-500/50',
    'border-purple-500/20', 'border-blue-500/20', 'border-emerald-500/20', 'border-green-500/20',
    'border-amber-500/20', 'border-indigo-500/20', 'border-cyan-500/20', 'border-rose-500/20',
    'border-slate-500/20', 'border-orange-500/20', 'border-teal-500/20', 'border-pink-500/20',
    'border-yellow-500/20', 'border-red-500/20', 'border-violet-500/20',
  ],
  theme: {
    extend: {
      fontFamily: {
